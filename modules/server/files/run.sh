...
docker run -i -t -d \
    ...
    -p 127.0.0.1:$[container_port+1+32768]:20 \
    -p 127.0.0.1:$[container_port+2+32768]:21 \
    -p 127.0.0.1:$[container_port+3+32768]:80 \
    -p 127.0.0.1:$[container_port+4+32768]:443 \
    -p 127.0.0.1:$[container_port+5+32768]:993 \
    -p 127.0.0.1:$[container_port+6+32768]:587 \
    -m $container_memory \
    --name="$container_name" \
